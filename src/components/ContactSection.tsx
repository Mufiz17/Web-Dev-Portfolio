              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:mufizhaq52@smk.belajar.id" className="text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 transition-colors">
                      mufizhaq52@smk.belajar.id
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+6281806346570" className="text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 transition-colors">
                      +62818 0634 6570
                    </a>
                  </div>
                </div>
              ...
              {submitted ? (
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-teal-500 hover:bg-teal-600 text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center disabled:opacity-70"
                  >
                    {isSubmitting ? (
